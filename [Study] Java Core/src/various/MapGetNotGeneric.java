...
public class MapGetNotGeneric {
	...
	/**
	 * The reason is that the key of the entry you are retrieving does not have to be the same type as the object that
	 * you pass in to the get() method. The specification of the method only requires that they are equal.
	 * 
	...
	/**
	 * OBS> Methods of the Java Collections Framework never restrict the types of their parameters except when it's 
	 * necessary to prevent the collection from getting broken.
	 * 
	 */
